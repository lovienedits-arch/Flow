...
function setupSearch(){
  ...
  // Manual typing clears live flag
  document.getElementById('origin-input').addEventListener('input', ()=> originIsLiveLocation=false);
  document.getElementById('origin-input').addEventListener('change', ()=> originIsLiveLocation=false);
...
function useMyLocation(target){
  ...
  navigator.geolocation.getCurrentPosition(async pos=>{
    ...
    toast('Live location set — now enter destination and Navigate');
  }, async err=>{
    let msg=err.message||'';
